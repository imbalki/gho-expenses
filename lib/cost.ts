...
export async function recordAiUsage(provider: 'groq' | 'openrouter', purpose: 'transcribe' | 'ocr' | 'extract', estCostUsd: number) {
  try {
 ...
 * provider bill — check Groq/OpenRouter's own dashboards for exact costs.
 */
